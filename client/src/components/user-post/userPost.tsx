    ...
    return (
        <article className="post">
            {post.text ? (
                ...
                <img src={post.attachments[0]} alt="placeholder" />
            )}
            ...
            {attachmentsCountRef.current > 0 &&
                ...
                post.attachments
                    .slice(post.text ? 0 : 1)
                    .map((att, i) => <img key={i} src={att} alt="placeholder" />)}
                ...
                {attachmentsCountRef.current > 0 && (
                    ...
                    >
                        {attachmentsOpen
                            ...
                            : `Show ${
                                  post.text
                                      ? attachmentsCountRef.current
                                      : attachmentsCountRef.current - 1
                              } more attachment${attachmentsCountRef.current > 1 ? "s" : ""}...`}
                    </p>
                )}
